...
export const createTypedForm = <State extends Record<string, unknown>>() => {
  return {
    ...
    useField: useField as <FieldName extends Extract<keyof State, string>, Value extends State[FieldName]>(field: FieldName) => [Value, (value: Value) => void],
    useFormContext: useFormContext as unknown as () => FormContextState<State>
  }
}
